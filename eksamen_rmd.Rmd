...
reg3 <- lm(playoffs ~ wins+loss+points_for+points_against+points_differential+margin_of_victory+strength_of_schedule+simple_rating+offensive_ranking+defensive_ranking+L(playoffs, 1), data = standings)
...
```{r}
reg4 <- lm(sb_winner ~ wins+loss+points_for+points_against+points_differential+margin_of_victory+strength_of_schedule+simple_rating+offensive_ranking+defensive_ranking, data = standings)

summary(reg4)


reg5 <- lm(sb_winner ~ wins+offensive_ranking+defensive_ranking, data = standings)

summary(reg5) #hypothesis 5
