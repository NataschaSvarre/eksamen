...
model_nb <- train(games_train[, 3:7], games_train[, 2], method = 'naive_bayes')  #preProcess=c("center", "scale") 
predictions_nb <- predict(object = model_nb, games_test[,3:7])
...
model_svm<- train(games_train[, 3:7], games_train[, 2], method = 'svmLinear',preProcess=c("BoxCox")) #preProcess=c("center", "scale")
...
#Decision tree
model_dt <- train(games_train[, 3:7], games_train[, 2], method = 'rpart') #preProcess=c("center", "scale")

predictions_dt <- predict(object = model_dt, games_test[,3:7])
