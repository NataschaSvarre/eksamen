...
standings$wins <- as.factor(standings$wins)
...
#### 6.3.1 Naive Bayes
```{r}
model_nb3 <- train(standings_train2[, 2:11], standings_train2[, 12], method = 'naive_bayes')  #preProcess=c("center", "scale") 
predictions_nb3 <- predict(object = model_nb3, standings_test2[,2:11])

# Confusion matrix 
confusionMatrix(predictions_nb3, standings_test2[,12], positive = "1")
