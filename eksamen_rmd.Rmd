...
games$winners_home <- ifelse(games$winners == games$home_team_name ,1,0)
...
```{r}
#Copied from Caroline



# Create index to split based on labels  
games_index <- createDataPartition(games$winners_home, p=0.8, list=FALSE)

# Subset training set with index
games_train <- games[index,]

# Subset test set with index
games_test <- games[-index,]
```
